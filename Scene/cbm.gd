...
func _on_dialogic_signal(value: String) -> void:
	...
	elif value == "cbmquestion":
		$Calc.show()
		$"PlayerTemplate/CanvasLayer/Mini Map".hide()
		$PlayerTemplate/CanvasLayer/jump.hide()
		$PlayerTemplate/CanvasLayer/run.hide()
		$"PlayerTemplate/CanvasLayer/Virtual Joystick".hide()
	elif value == "corevaluesbook":
